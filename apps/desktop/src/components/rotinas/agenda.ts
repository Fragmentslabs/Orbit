...
import type { Agenda } from "@shared/rotinas"
import { parseHorario } from "@shared/rotinas"

/** Helpers puros da agenda — separados dos componentes por causa do fast refresh. */
