...
export const MessageBubble = memo(function MessageBubble({ message, isLast, isBusy }: MessageBubbleProps) {
  return <ChatAssistantMessage message={message} isLast={isLast} isBusy={isBusy} />
})
